...
func main() {
	...
	buffer.InitializeCandleBuffer(cfg.CandleBuffer, candlesProducer)
...

	{
		...
		sahamyabStreamWorker := sahamyabStream.NewWorker(logger, cfg.SahamyabStream, candlesProducer, postRepo)
		...
		if cfg.MarketUpdateWorker.NeedWarmup {

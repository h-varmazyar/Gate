...
func (c *indicatorServiceClient) List(ctx context.Context, in *IndicatorListReq, opts ...grpc.CallOption) (*Indicators, error) {
	out := new(Indicators)
	err := c.cc.Invoke(ctx, "/chipmunkApi.indicatorService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _IndicatorService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chipmunkApi.indicatorService/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var IndicatorService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/chipmunk/api/proto/src/indicator.proto",
}
